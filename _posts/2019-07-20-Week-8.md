...
|Method|DBQNA BLEU score|DBQNA F1 score|DBQNA Answer Type F1 score|QALD BLEU score|QALD F1 score|QALD Answer Type F1 score|
| :-----| :----: | :----: | :----: | :----: | :----: |
| NSpM | 64.55 | 0.0072 | 0.6587 | 80 | 0.0072 | 0.6587 |
| dependency parsing + Spotlight | 单元格 | 单元格 | 单元格 | 单元格 | 单元格 | 单元格 |
| dependency parsing + Spotlight + vector similarity | 单元格 | 单元格 | 单元格 | 单元格 | 单元格 | 单元格 |
